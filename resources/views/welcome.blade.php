...
<div class="slider-wrapper row">
    <div class="slider">
        ...
        <div class="slide">
            <img src="{{asset('assets/images/fraction-slider/base.jpg')}}" width="1170" height="auto" data-in="top" data-out="fade" data-delay=""/>
            <img src="{{asset('assets/images/fraction-slider/slider-boy.png')}}" width="413" height="413" data-position="60,650" data-in="right" data-out="left" data-delay="1500"/>
        ...
        <div class="slide">
            <img src="{{asset('assets/images/fraction-slider/base_2.jpg')}}" width="1170" height="auto" data-in="fade" data-out="fade"/>
            ...
            <img src="{{asset('assets/images/fraction-slider/gadgets/3.png')}}" width="223" height="260" data-position="100,450" data-in="fade" data-out="fade" data-delay="1500"/>
        ...
        <div class="slide">
            <img src="{{asset('assets/images/fraction-slider/base_3.jpg')}}" data-in="fade" data-0ut="fade" width="1170" height="auto">

            <img src="{{asset('assets/images/fraction-slider/gadgets/mack.png')}}" width="327" height="287" data-position="30,700" data-in="right" data-out="left" data-delay="20">
            <img src="{{asset('assets/images/fraction-slider/gadgets/ipad.png')}}" width="90" height="135" data-position="160,680" data-in="left" data-out="right" data-delay="1000">
            <img src="{{asset('assets/images/fraction-slider/gadgets/smartphone.png')}}" width="40" height="80" data-position="230,660" data-in="bottom" data-out="bottom" data-delay="1500">

            <p class="style heading" data-position="50,180" data-in="top" data-out="top" data-delay="2000" data-ease-in="easeOutBounce">Build Your Proffessional Website</p>

            <p class="list" data-position="120,210" data-in="right" data-out="left" data-delay="2100">SEO Friendly Website</p>
            <p class="list" data-position="150,210" data-in="right" data-out="right" data-delay="3000">7 combination color option</p>
            <p class="list" data-position="180,210" data-in="right" data-out="left" data-delay="3900">Animated layer slider</p>
            <p class="list" data-position="210,210" data-in="right" data-out="right" data-delay="4800">Much More Featured...</p>
            ...
            <p class=" icon" data-position="210,180" data-in="top" data-out="bottom" data-delay="1400" data-ease-in="easeOutBounce"><i class="fa fa-check"></i></p>
...
<!--End Slider-->
    ...
    <div class="grey_bg pdt-70 row">
        <div class="col-sm-5 feature-block">
            <img class="img-responsive center-block" src="{{asset('assets/images/laptop.png')}}"/>
        </div>
...
<!-- Parallax with Testimonial -->
                ...
                <div class="carousel-inner">
                    <div class="active item">
                        <div class="parallax-testimonial-item">
                            ...
                            <div class="parallax-testimonial-review">
                                <img src="{{asset('assets/images/testimonials/1.png')}}" alt="testimonial">
                    ...
                    <div class="item">
                        <div class="parallax-testimonial-item">
                            ...
                            <div class="parallax-testimonial-review">
                                <img src="{{asset('assets/images/testimonials/2.png')}}" alt="testimonial">
                                <span>Jonathan Dower</span>
                                <small>Leopard</small>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="parallax-testimonial-item">
                            ...
                            <div class="parallax-testimonial-review">
                                <img src="{{asset('assets/images/testimonials/3.png')}}" alt="testimonial">
                                <span>Jonathan Dower</span>
                                <small>Leopard</small>
                            </div>
                        </div>
    ...
    <div class="row super_sub_content">
        <div class="col-sm-7">
            <img class="img-responsive center-block" src="{{asset('assets/images/imac.png')}}"/>
        </div>
    ...
    <div class="feature-block row pdt-50">
        <div class="col-md-7 text-center">
            <img class="" src="{{asset('assets/images/awesome-img.png')}}"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="super_sub_content grey_bg row">
        ...
        <div class="col-md-4">
            <img src="{{asset('assets/images/phones.png')}}" class="img-responsive center-block">
        </div>
        ...
        <div class="col-md-12">
            ...
            <div id="post-slider" class="owl-carousel">
                <div class="post-slide">
                    <div class="post-img">
                        <img src="{{asset('assets/images/blog/blog_1.png')}}">
                    </div>
                ...
                <div class="post-slide">
                    <div class="post-img">
                        <img src="{{asset('assets/images/blog/blog_2.png')}}">
                    </div>
                    <h5 class="post-title"><a href="blog-post.html">Latest News Post</a></h5>
                    <div class="post-date">
                        <i class="fa fa-calendar"></i> April 23, 2015
                ...
                <div class="post-slide">
                    <div class="post-img">
                        <img src="{{asset('assets/images/blog/blog_3.png')}}">
                    </div>
                    <h5 class="post-title"><a href="blog-post.html">Latest News Post</a></h5>
                    <div class="post-date">
                        <i class="fa fa-calendar"></i> April 23, 2015
                ...
                <div class="post-slide">
                    <div class="post-img">
                        <img src="{{asset('assets/images/blog/blog-4.png')}}">
                    </div>
                    <h5 class="post-title"><a href="blog-post.html">Latest News Post</a></h5>
                    <div class="post-date">
                        <i class="fa fa-calendar"></i> April 23, 2015
